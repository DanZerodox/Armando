...
export class FormularioMovil extends React.Component {
    ...
    render() {
        return (
           <div>
                ...
                <textarea style={{width:'100%'}} type="text"  value={this.state.direccion} name="Email" disabled={true}/>
    ...
    LlenarCampos() {
        var datos = [
            ...
            {"CD":"VILLAHERMOSA","DIRECCION":"AV. OXIGENO MANZANA 5 LT. 5, CD. INDUSTRIAL 2DA ETAPA MPO. CENTRO VILLAHERMOSA, TABASCO C.P. 86010","RESPONSABLE":"ARACELI CHAVEZ","CONTACTO":"99 3159 4167","CORREO":"gvhs@jumex.com.mx","SERVICIO":"IDE / INFINITUM","TIPO":"COBRE?","LINEA1":"993 3533481","LINEA2":"9933533482,00","LINEA3":"-","LINEA4":"-","LINEA5":"-","VOZ1":"9933532375","VOZ2":"-","VOZ3":"-","VOZ4":"-","VOZ5":"-","CAS":"CASE MERIDA","CONTACTOCAS":"800 2011100","REFERENCIA":"CB4-1509-0028","VELOCIDADDE":"4 MB","VELOCIDADEN":"0","CARE":"UNINET","CONTACTOCARE":"01800 007 7700"},
